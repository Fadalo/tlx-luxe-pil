...
<div>
    ...
    <div class="cal-footer">
        ...
        <div class="cal-schedule">
            ...
            bottom: 80px;
        ">
            <a href="#" wire:click='doChange({{$value['id']}})' class="float-end btn btn-s bg-highlight rounded-s shadow-xl text-uppercase font-900 font-11 mt-2" style="margin-right:5px">Change Schedule</a>
