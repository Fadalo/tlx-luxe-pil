...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>LUXE-PILATES REGISTER</title>
            ...
            <div class="container-fluid p-0">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="p-3">
                            <form class="form-horizontal mt-3" action="{{ route('register.save') }}">
                                @csrf
                                ...
                                <div class="form-group mb-3 row">
                                    <div class="col-12">
                                        <input class="form-control" type="text" required="" placeholder="PhoneNo">
                                    </div>
                                </div>
                                <div class="form-group mb-3 row">
                                    <div class="col-12">
                                ...
                                <div class="form-group mb-3 row">
                                    <div class="col-12">
                                        <input class="form-control" type="password" required="" placeholder="PIN">
                                    </div>
                                </div>
