            ...
            <div class="container-fluid p-0">
                 <div style="padding:30px;margin-top:100px">
                        ...
                        <div class="text-center mt-4">
                            <span style="color:white;font-size:48px;">  INSTRUCTOR </span>
                        </div>
                        
                        <h4 class="text-center font-size-18" style="color:white;"><b>LOGIN INSTRUCTOR</b></h4>
    
                        <div class="p-3">
                            <form class="form-horizontal mt-3" method="POST" action="{{ route('Auth.instructor.login.auth') }}">
                                @csrf
