...
<div class="content">
   ...
   // exit();
    ...
    <a  href="{{route('member.booking')}}" class="float-end btn btn-s bg-highlight rounded-s shadow-xl text-uppercase font-900 font-11 mt-2">Booking</a>
    <a href="{{route('member.detailBooking')}}#" class="float-end btn btn-s bg-highlight rounded-s shadow-xl text-uppercase font-900 font-11 mt-2" style="    margin-right: 6px;">Detail</a>
</div>
