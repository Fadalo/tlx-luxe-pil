...
<div class="page-title page-title-small">
    <h2><a href="{{ route('member.listPackage')}}#" data-back-button=""><i class="fa fa-arrow-left"></i></a>LUXE MEMBER - DETAIL BOOKING</h2>
...
<livewire:ComponentMemberDetailBooking :member_package_order_id="$_GET['id']" >
