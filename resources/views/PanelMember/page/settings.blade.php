...
@section('meta_title','MEMBER-SETTINGS')
@section('contentsMenu')
<?php
     $menu_link = 'member.settings';
    ?>
...
<div class="page-title page-title-small">
    ...
    <a href="{{ route('member.settings')}}#" data-menu="menu-main" class="bg-fade-highlight-light shadow-xl preload-img" data-src="{{env('APP_ASSET_MEMBER_URL')}}/images/menu.png"></a>
</div>
