<div id="footer-bar" class="footer-bar-5">
    ...
    <a href="{{ route('member.profile')}}"><i data-feather="user" data-feather-line="1" data-feather-size="21" data-feather-color="dark-dark" data-feather-bg="gray-fade-light"></i><span>Settings</span></a>
</div>
