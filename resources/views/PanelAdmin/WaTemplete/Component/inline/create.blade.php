...
//exit();
?>
<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasRole" aria-labelledby="offcanvasRoleLabel">
    <div class="offcanvas-header">
        <h5 class="offcanvas-title" id="offcanvasRoleLabel">Create Package</h5>
    ...
    <div class="offcanvas-body">
        ...
        <hr>
        <form id="formRole" method="POST" autocomplete="off" action="{{ route('admin.role.create') }}" >
            @csrf
            <div class="row">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const saveButton = document.querySelector('#formRole button[name="btnSave"]');
    const saveClear  = document.querySelector('#formRole button[name="btnClear"]');
    // Optional: Add an event listener to the button
    saveButton.addEventListener('click', function(event) {
         // Prevent form submission for demonstration
        ajaxable('#formRole').onStart(function(params) {
