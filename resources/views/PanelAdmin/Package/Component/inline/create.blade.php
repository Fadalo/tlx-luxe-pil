...
//exit();
?>
<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasPackage" aria-labelledby="offcanvasPackageLabel">
    <div class="offcanvas-header">
        <h5 class="offcanvas-title" id="offcanvasPackageLabel">Create Package</h5>
    ...
    <div class="offcanvas-body">
        ...
        <hr>
        <form id="formPackage" method="POST" autocomplete="off" action="{{ route('admin.package.create') }}" >
            @csrf
            <div class="row">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const saveButton = document.querySelector('#formPackage button[name="btnSave"]');
    const saveClear  = document.querySelector('#formPackage button[name="btnClear"]');
    // Optional: Add an event listener to the button
    saveButton.addEventListener('click', function(event) {
         // Prevent form submission for demonstration
        ajaxable('#formPackage').onStart(function(params) {
        ...
        .onResponse(function(res, params) {
            ...
            $('#offcanvasPackage .btn-close').click();
            Swal.fire({
                title: 'Success',
                text: result.message,
                icon: 'success',
