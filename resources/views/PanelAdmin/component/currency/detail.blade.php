<div id="field_{{ $MetaKey}}" class="mb-3">
    ...
    <input id="{{$MetaKey}}" name="{{$MetaKey}}" type="number" class="form-control"  placeholder="" disabled value="{{$objValue[$MetaKey] }}"
        required="">
    <span class="btn-group-edit_{{$MetaKey }}" style="position:absolute;right:11px;top:7px">
        ...
        <span  style="display:none">
            <a type="submit"><i class="ri-save-line"></i></a>
