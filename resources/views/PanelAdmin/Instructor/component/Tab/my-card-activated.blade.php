<div class="row">
    @for($i=0;$i<= 1 ; $i++) <div class="col-md-12">
            ...
            <div class="row no-gutters align-items-center">
                ...
                <div class="col-md-8">
                    <div class="card-body">
                        ...
                        <p class="card-text">Expired At [ 19-09-2024 ]<br>Auto Actived In 7 Days<br>Used Ticket 1/10</p>
                ...
                <div class="col-md-4">
                    <div style="height:200px">
                        <div class="mt-3" style="display: flex;justify-content: flex-end;margin-right: 10px;">
                            <button class="btn btn-success rounded-0">BOOK SESSION</button>
                        </div>
                    </div>
                </div>
