...
//exit();
?>
<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasInstructor" aria-labelledby="offcanvasInstructorLabel">
    <div class="offcanvas-header">
        <h5 class="offcanvas-title" id="offcanvasInstructorLabel">Create Instructor</h5>
    ...
    <div class="offcanvas-body">
        ...
        <hr>
        <form id="formInstructor" method="POST" action="{{ route('admin.instructor.create') }}" >
            @csrf
            <div class="row">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const saveButton = document.querySelector('#formInstructor button[name="btnSave"]');
    const saveClear  = document.querySelector('#formInstructor button[name="btnClear"]');
    // Optional: Add an event listener to the button
    saveButton.addEventListener('click', function(event) {
         // Prevent form submission for demonstration
        ajaxable('#formInstructor').onStart(function(params) {
        ...
        .onResponse(function(res, params) {
            ...
            $('#offcanvasInstructor .btn-close').click();
            Swal.fire({
                title: 'Success',
                text: result.message,
                icon: 'success',
